          ...
          <div className="max-w-5xl mx-auto flex flex-col items-center gap-8 md:gap-20 relative z-10">
            ...
            <div className="flex flex-col items-center gap-3.5 text-center">
              ...
              <p className="text-sm md:text-lg lg:text-xl text-white max-w-[1100px] leading-[130%] md:leading-relaxed">
                Every recovery starts with one action. Report your missing item
                with confidence or join our community and play a meaningful role
                in reconnecting people with what they've lost. Fyndae ensures
                safety, transparency and support at every stage of the journey.
              </p>
            </div>
