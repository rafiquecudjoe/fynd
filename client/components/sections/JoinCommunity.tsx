          ...
          <div className="max-w-7xl mx-auto flex flex-col gap-8 md:gap-15">
            ...
            <div className="flex flex-col items-center justify-center gap-4 md:gap-5 text-center">
              ...
              <p className="text-sm md:text-lg lg:text-xl text-white leading-[130%] md:leading-relaxed max-w-4xl">
                Join thousands of community members who provide timely
                information, support their neighborhoods and help reunite people
                with lost possessions and loved ones while earning verified
                rewards
              </p>
            </div>
            ...
            <div className="bg-[#419084] border-[0.5px] border-[#B8D5D1] rounded-2xl p-4 md:p-5">
              <div className="flex flex-col gap-2.5 md:gap-5 md:grid md:grid-cols-1 lg:grid-cols-3">
                <CommunityCard
                  icon={
                    <Lock className="w-8 h-8 md:w-9 md:h-9 text-[#383D48]" />
                  }
                ...
                <CommunityCard
                  icon={
                    <Users className="w-8 h-8 md:w-9 md:h-9 text-[#383D48]" />
                  }
                ...
                <CommunityCard
                  icon={
                    <Bell className="w-7 h-7 md:w-8 md:h-8 text-[#383D48]" />
                  }
            ...
            <div className="flex justify-center">
              <Button
                asChild
                className="bg-[#F7F7F8] hover:bg-white text-[#0D0B1A] border-[0.5px] border-[#B7BECD] px-6 py-3 text-sm md:text-lg font-medium rounded-lg leading-[150%]"
              >
  ...
  return (
    <div className="bg-white border border-[#F1F1F3] rounded-2xl p-6 md:p-7 flex flex-col gap-6 min-h-[251px]">
      <div className="flex flex-col items-center justify-center gap-2.5 text-center">
        ...
        <h3 className="text-xl font-semibold text-[#0A0814] leading-[150%]">
          {title}
        </h3>
      </div>
