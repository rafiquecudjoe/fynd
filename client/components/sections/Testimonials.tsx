        ...
        <div className="flex flex-col gap-5 md:gap-5 mt-6 md:mt-12">
          ...
          <div className="flex flex-col gap-5 md:hidden">
            ...
            <div className="bg-[#F7F7F8] rounded-[20px] p-10 flex flex-col justify-center gap-6 relative">
              {/* Quote Icon */}
              <svg className="w-10 h-7 absolute right-7 top-7 opacity-100" viewBox="0 0 40 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_4065_718)">
                  <path d="M8.48735 18.7635C7.73161 22.928 6.47698 25.9193 5.47673 27.7721C5.08651 28.4963 5.88424 29.3024 6.59305 28.8857C14.963 23.9871 18.6331 16.8413 19.09 11.1117C19.4827 6.1684 16.1263 1.07877 11.0386 0.151127C5.94845 -0.774035 1.07564 2.61657 0.151957 7.72853C-0.816183 13.086 2.94524 18.2327 8.48735 18.7635Z" fill="#117465"/>
                  <path d="M29.3716 18.7642C28.6159 22.9286 27.3612 25.9199 26.361 27.7727C25.9708 28.497 26.7685 29.3031 27.4773 28.8864C35.8473 23.9877 39.5173 16.8419 39.9742 11.1124C40.3669 6.16906 37.0105 1.07943 31.9228 0.151783C26.8352 -0.77586 21.9599 2.61723 21.0387 7.72671C20.0705 13.0842 23.832 18.2309 29.3741 18.7617L29.3716 18.7642Z" fill="#117465"/>
                </g>
                <defs>
              ...
              <div className="flex flex-col gap-0.5">
                <h4 className="text-base font-semibold text-[#1D1D1D] leading-[150%]">Lerato D. CapeTown</h4>
                <p className="text-sm text-[#3F3E4D] leading-[130%]">Fyndae User</p>
              </div>
            </div>
          </div>
