            ...
            <div className="flex flex-col items-center gap-8 md:gap-10 mb-10 md:mb-12">
              <div className="flex flex-col items-center gap-4 text-center">
                <h2 className="text-xl md:text-3xl lg:text-4xl xl:text-[36px] font-semibold leading-[140%] tracking-[-0.05em] md:tracking-[-0.056em]">
                  ...
                  <span className="text-black">
                    {" "}
                    has connected thousands of users, verified hundreds of
                    profiles and institutions and facilitated the recovery of
                    countless missing items through authentic leads and secure
                    rewards.
                  </span>
                </h2>
                <p className="text-sm md:text-lg lg:text-xl max-w-[1130px] text-black leading-[130%] md:leading-[150%]">
                  ...
                  system, we're building a safer, more reliable way for people
                  to find what they've lost and confirm who they can trust.
                </p>
              </div>
