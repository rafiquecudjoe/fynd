          ...
          <div className="max-w-[1232px] mx-auto flex flex-col items-center gap-8 md:gap-10">
            <div className="text-center space-y-5">
              ...
              <p className="text-white text-sm md:text-lg lg:text-xl leading-[130%] md:leading-[150%] max-w-[900px] mx-auto">
                ...
                our secure escrow system to reward verified leads when your item
                is found.
              </p>
            </div>
            ...
            <a
              href="/login"
              className="px-6 py-3 rounded-lg border border-gray-40 bg-[#F7F7F8] text-gray-100 font-medium text-sm md:text-lg leading-[150%] hover:bg-gray-50 transition-colors"
            >
              Get Started
            </a>
          </div>
